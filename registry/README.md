...
Socrata also uses current-snapshot registries:

- `socrata_primary_registry.csv`
- `socrata_distributions_registry.csv`

The Socrata registries are initialized from the 2026-07-05 primary and
distribution outputs. Subsequent runs produce new and retired primary records
and added/deleted distribution rows before updating the snapshots while
preserving `Date Accessioned`.
